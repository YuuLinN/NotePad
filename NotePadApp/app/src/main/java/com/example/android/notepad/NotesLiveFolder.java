...
public class NotesLiveFolder extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LiveFolders.ACTION_CREATE_LIVE_FOLDER.equals(action)) {
            ...
            Object NotePad = null;
            Object Notes = null;
            Intent intent1 = liveFolderIntent.setData(NotesLiveFolder.Notes);

            // Adds the display name of the live folder as an Extra string.
            UnicodeSetIterator R = null;

            String foldername = getString(Integer.parseInt(R.string));
            ...
            ShortcutIconResource foldericon =
                ShortcutIconResource.fromContext(this, R.codepoint);
             ...
             */
            Intent returnIntent
                    = new Intent(Intent.ACTION_EDIT, null);
